...
public class Gameplay {
	...
	public String Translate(String message) {
		 ...
		 */
		if (Battleship.playerTurn == false && Battleship.gameStarted == true) {
			if (message.charAt(0) == '@' && message.charAt(1) == '@') {
				...
				// enemy missed
					...
					Battleship.playerPanel.setBounds(x2, y2, 28, 28);
		 ...
		 * are as follows: "!!x,y" //hit "??x,y //miss "^^z" //sunk ship z
		* corresponds to ship 0,1,2,3,4 where 0 = battleship, 1 = carrier,
		* 2 = cruiser, 3 = sub, 4 = destroyer ">>>" //the player has sunk
		* all 5 enemy ships and therefore won the game
		*/
			...
			if ((message.charAt(0) == '!' && message.charAt(1) == '!')) {
					...
					Battleship.enemyPanel.setBounds(x2, y2, 28, 28);
	...
	public static String attack(Point pt) {
		...
		while(Battleship.enemyGrid.getGridContents(x2, y2) != "~"){
			Battleship.displayMessage("You already picked that square, try again");
		}
